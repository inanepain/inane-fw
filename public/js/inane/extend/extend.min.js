if(!Object.prototype.watch){Object.defineProperty(Object.prototype,'watch',{enumerable:!1,configurable:!1,writable:!0,value:function(prop,handler){var change={property:prop,value:this[prop],previous:undefined,set update(v){if(this.value===v)return!1;this.previous=this.value;this.value=v;return!0}},getter=function(){return change.value},setter=function(val){if(change.update=val)handler.call(this,change);return val};if(delete this[prop]){Object.defineProperty(this,prop,{get:getter,set:setter,configurable:!0})}}})}
if(!Object.prototype.unwatch){Object.defineProperty(Object.prototype,'unwatch',{enumerable:!1,configurable:!1,writable:!0,value:function(prop){const val=this[prop];delete this[prop];this[prop]=val}})}
if(!Object.prototype.jsonString){Object.defineProperty(Object.prototype,'jsonString',{enumerable:!1,configurable:!1,writable:!0,value:function(replacer=null,space=null){return JSON.stringify(this,replacer,space)}})}
...
if(!Object.prototype.values){Object.defineProperty(Object.prototype,'values',{enumerable:!1,configurable:!1,writable:!0,value:function(){return Object.values(this)}})};if(!Array.prototype.unique){Array.prototype.unique=function(){const unique=[];for(let i=0;i<this.length;i++)if(!unique.includes(this[i]))unique.push(this[i]);return unique}}
...
if(!Number.prototype.log){Number.prototype.log=function(){console.log(this.constructor.toString().split(' ')[1].replace('()','').toLowerCase()+'('+this.toString().length+'): '+this.toString())}};if(!String.prototype.toTitleCase){String.prototype.toTitleCase=function(lowerAsWell=!1,isName=!1){let string=lowerAsWell===!0?this.toLowerCase():this;if(isName)return string.replace(/\b[a-z]/g,txt=>{return txt.charAt(0).toUpperCase()+txt.substring(1).toLowerCase()});else return string.replace(/(?:^|\s)\w/g,function(match){return match.toUpperCase()})}}
